            ...
            <div class="container-fluid d-flex justify-content-center">
                ...
                <div class="card card-outline card-primary shadow-sm mb-4" style="width: 20rem;">
                    <div class="card-header text-center py-4">
                        <h2 class="card-title mb-0 font-weight-bold">{{ $product->title }}</h2>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center text-muted small mt-3 border-top pt-3">
                            <p class="mb-1">Published on: {{ $product->created_at->format('M d, Y') }}</p>
                            @if ($product->updated_at != $product->created_at)
                                <p class="mb-0">Last updated: {{ $product->updated_at->format('M d, Y') }}</p>
                            @endif
                        </div>
