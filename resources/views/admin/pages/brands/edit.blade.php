        ...
        <div class="app-content">
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <form id="form" action="{{ route('slider.update', $slider->id) }}" method="POST"
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="description" class="form-control" id="editor" rows="5">{!! old('text', $slider->description) !!}</textarea>
                            </div>
