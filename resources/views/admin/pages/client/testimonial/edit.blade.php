        ...
        <div class="app-content">
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <form id="form" action="{{ route('testimonial.update', $testimonial->id) }}" method="POST"
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="text" class="form-control" id="editor" rows="5">{!! old('text', $testimonial->text) !!}</textarea>
                            </div>
