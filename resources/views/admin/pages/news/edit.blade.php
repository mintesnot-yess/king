        ...
        <div style="max-width: 90% ;margin:20px auto" class="app-content">
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <form id="form" action="{{ route('news.update', $news->id) }}" method="POST"
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="title" class="form-control" id="title"
                                    placeholder="Enter title" value="{{ old('title', $news->title) }}" />
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="description" class="form-control" id="editor" rows="5">{!! old('description', $news->description) !!}</textarea>
