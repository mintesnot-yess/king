                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="hero-content">
                                        ...
                                        <div class="section-title dark-section">
                                            ...
                                            <p class="wow fadeInUp" data-wow-delay="0.2s">Whether for homes, offices, or warehouses, our doors offer the perfect blend of strength, reliability, and modern design.</p>
                                        </div>
                                        <!-- Section Title End -->
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="hero-content">
                                        ...
                                        <div class="section-title dark-section">
                                            ...
                                            <p class="wow fadeInUp" data-wow-delay="0.2s">Every steel door we produce is crafted with precision, premium materials, and a commitment to lasting value.</p>
                                        </div>
                                        <!-- Section Title End -->
                ...
                <div class="col-lg-6">
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">King Steel Security Door Manufacturing</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">is a locally pioneering sole proprietorship producing
                                high-demand steel doors. The initial capital investment for the enterprise amounted to 140,000,000
                                Ethiopian Birr (ETB), Established in 2011 E.C. in the industrial area of Addis Ababa, near Gelan Condominium.</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="about-item-box">
                            ...
                            <div class="about-us-item wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <div class="about-item-content">
                                    <h3>our mission</h3>
                                    <p>Producing best steel door and related products in the spectrum of various designs by using genuine
                                        raw materials and inputs, modern production technologies with qualified man power in the manner of
                                        optimizing customer’s satisfaction.</p>
                                </div>
                            </div>
                            <!-- About Us Item End -->
                            ...
                            <div class="about-us-item wow fadeInUp" data-wow-delay="0.6s">
                                ...
                                <div class="about-item-content">
                                    <h3>our vision</h3>
                                    <p>To best steel door manufacturer in Ethiopia and across east Africa.</p>
                                </div>
                            </div>
                            <!-- About Us Item End -->
                        </div>
            ...
            <div class="row section-row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">Comprehensive services</h2>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
                    ...
                    <div class="service-content-box">
                        ...
                        <div class="service-box-item wow fadeInUp">
                            ...
                            <div class="service-item-content">
                                <h3>Custom Steel Door Manufacturing</h3>
                                <p>We design and fabricate high-strength steel doors tailored to client specifications — size, thickness, color, and style.</p>
                            </div>
                        </div>
                        ...
                        <div class="service-box-item wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="service-item-content">
                                <h3>Standard Security Door Production</h3>
                                <p>Mass production of standard-sized doors for residential, commercial, and industrial use, with quick turnaround and consistent quality.</p>
                            </div>
                        </div>
                        <!-- Service Box Item End -->
                        ...
                        <div class="service-box-item wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="service-item-content">
                                <h3>Design & Engineering Consultation</h3>
                                <p>Technical support in selecting the right door type, locking mechanism, and frame structure for different projects.</p>
                            </div>
                        </div>
                        <!-- Service Box Item End -->
                    </div>
                ...
                <div class="col-lg-4 col-md-6 order-lg-3 order-md-2">
                    ...
                    <div class="service-content-box">
                        ...
                        <div class="service-box-item wow fadeInUp">
                            ...
                            <div class="service-item-content">
                                <h3>Door Frame & Accessory Fabrication</h3>
                                <p>Production of compatible door frames, hinges, locks, handles, peepholes, and ventilation grilles.</p>
                            </div>
                        </div>
                        <!-- Service Box Item End -->
                        ...
                        <div class="service-box-item wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="service-item-content">
                                ...
                                <p>On-site delivery and expert installation ensuring proper fit, secure anchoring, and long-term durability.</p>
                            </div>
                        </div>
                        <!-- Service Box Item End -->
                        ...
                        <div class="service-box-item wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="service-item-content">
                                <h3>Powder Coating & Finishing</h3>
                                <p>Durable and attractive surface finishes including anti-rust coatings, powder painting, and texture options.</p>
                            </div>
                        </div>
                        <!-- Service Box Item End -->
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="our-work-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Why we're the right choice for your door</h2>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="work-content-body">
                            <div class="our-work-list wow fadeInUp" data-wow-delay="0.4s">
                                <ul>
                                    ...
                                    <li>Made for Ethiopian Conditions</li>
                                    <li>Fast & Reliable Delivery</li>
                                    <li>Skilled Team & Expert Support</li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-video-box">
                        ...
                        <div class="intro-video-image">
                            <figure>
                                <a href="https://www.youtube.com/watch?v=GucPLJlc3nA" class="popup-video" data-cursor-text="Play">
                        ...
                        <div class="video-play-button">
                            <a href="https://www.youtube.com/watch?v=GucPLJlc3nA" class="popup-video" data-cursor-text="Play">play</a>
                        </div>
                            ...
                            <div class="accordion-item wow fadeInUp">
                                <h2 class="accordion-header" id="heading1">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                                        <span>1.</span> What types of steel doors do you manufacture?
                                    </button>
                                </h2>
                                <div id="collapse1" class="accordion-collapse collapse show" aria-labelledby="heading1" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        <p>We manufacture a wide range of steel doors including security doors, fire-rated doors, bulletproof doors, interior/exterior doors, and custom-designed solutions for residential, commercial, and industrial projects.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- FAQ Item End -->
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                                <h2 class="accordion-header" id="heading2">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                        <span>2.</span> Can I order custom-size or design doors?
                                    </button>
                                </h2>
                                <div id="collapse2" class="accordion-collapse collapse" aria-labelledby="heading2" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        <p>Yes. We offer fully customizable steel doors based on your preferred size, color, finish, design pattern, locking system, and accessories.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- FAQ Item End -->
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                                <h2 class="accordion-header" id="heading3">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                        <span>3.</span> Are your doors made in Ethiopia?
                                    </button>
                                </h2>
                                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="heading3" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        <p>Yes. All our steel doors are proudly manufactured in Ethiopia using locally and internationally sourced materials to ensure durability and quality.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- FAQ Item End -->
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                                <h2 class="accordion-header" id="heading4">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                                        <span>4.</span> Do you offer delivery and installation services?
                                    </button>
                                </h2>
                                <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading4" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        <p>Absolutely. We provide nationwide delivery and professional installation services to ensure your door is perfectly fitted and secured.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- FAQ Item End -->
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                                <h2 class="accordion-header" id="heading5">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                                        <span>5.</span> Are your doors weather-resistant and rust-proof?
                                    </button>
                                </h2>
                                <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="heading5" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        <p>Yes. Our doors are treated with anti-rust coatings and powder finishes, making them suitable for both indoor and outdoor use in all Ethiopian climates.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- FAQ Item End -->
            ...
            <div class="row section-row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">Expert tips and insights for doors</h2>
                    </div>
                    <!-- Section Title End -->
                </div>
                ...
                <div class="col-lg-6">
                    <!-- Section Title Content Start -->
                    <div class="section-title-content">
                        <p class="wow fadeInUp" data-wow-delay="0.2s">Stay informed with professional advice, design trends, and practical solutions for enhancing your doors.</p>
                    </div>
                    <!-- Section Title Content End -->
                </div>
            </div>
